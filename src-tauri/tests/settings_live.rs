...
use gh_client_backend::features::settings::service::SettingsService;

#[test]
fn live_list_collaborators_against_real_gh() {
    ...
    let trace = TraceContext::new("live-test-settings-collaborators-list");
    let result = service.list_collaborators(RepoPermission::Admin, &owner, &repo, &trace);
